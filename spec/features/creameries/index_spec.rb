...
RSpec.describe Creamery, type: :feature do
    ...
    it "links to edit each creamery" do
        ...
        visit '/creameries'
        click_link "Update #{creamery1.name}"
        expect(current_path).to eq("/creameries/#{creamery1.id}/edit")
    end

    it "can delete from creamery's index page " do
